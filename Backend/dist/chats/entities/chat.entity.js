...
const chat_user_entity_1 = require("./chat-user.entity");
let Chat = class Chat {
};
exports.Chat = Chat;
__decorate([
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], Chat.prototype, "created_by", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => chat_user_entity_1.ChatUser, (chatUser) => chatUser.chat),
    __metadata("design:type", Array)
