...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Получить пользовавтеля по username' }),
    (0, swagger_1.ApiParam)({ name: 'username', type: String, description: 'Username пользователя' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', type: Number, description: 'ID пользователя для обновления' }),
    (0, swagger_1.ApiBody)({ type: update_user_dto_1.UpdateUserDto, description: 'Данные пользоавтеля для обновления' }),
    __param(0, (0, common_1.Param)('id')),
